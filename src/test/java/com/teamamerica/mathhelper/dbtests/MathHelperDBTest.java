package com.teamamerica.mathhelper.dbtests;
    ...
    public static void main(String[] args) {
     ...
     //   System.out.println("Need user added: " + mathHelperDBClient.add_newUser(new User("tim12", "password", "S")));
       // mathHelperDBClient.print_users();
        ...
        ArrayList<Tutorial> tutorials = mathHelperDBClient.searchTutorials_grLevel(GradeLevel.K);
        for(Tutorial t : tutorials){
            System.out.println(t.getTutorial());
        }

        ArrayList<Question> questions = mathHelperDBClient.searchQuestions_grLevel(GradeLevel.K);
